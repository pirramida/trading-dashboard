...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  dbQuery: (query, params) => {
    console.log(
      "[preload] dbQuery called with query:",
      query,
      "params:",
      params
    );
  ...
  dbUpdate: (table, id, data) => {
    console.log(
      "[preload] dbUpdate called with table:",
      table,
      "id:",
      id,
      "data:",
  ...
  connectExchange: (exchange, apiKey, apiSecret) => {
    console.log(
      "[preload] connectExchange called with:",
      exchange,
      apiKey,
      "****"
    );
  ...
  getExchangeData: (exchange, symbol, type) => {
    console.log(
      "[preload] getExchangeData called with:",
      exchange,
      symbol,
      type
    );
    return ipcRenderer
      .invoke("get-exchange-data", exchange, symbol, type)
      .then((response) => {
        console.log("[preload] getExchangeData response:", response);
        return response;
      });
  },
